    ...
    <main className="mx-auto max-w-7xl px-6 py-10 space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
        {[
          ...
          <Link key={a.label} href={a.href} className="glass-card flex items-center gap-3 p-4 transition-shadow hover:shadow-md">
          ...
          {(!dashboard?.recent_documents || dashboard.recent_documents.length === 0) ? (
            ...
            <div className="space-y-2">
              {dashboard.recent_documents.map((doc) => (
                <div key={doc.id} className="flex items-center justify-between rounded-lg bg-[rgba(255,248,240,0.3)] px-3 py-2">
