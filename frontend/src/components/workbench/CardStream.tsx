        ...
        >
          ...
          <div className="mb-2 flex items-start justify-between">
            <div className="flex items-center gap-2">
              <span className="flex h-7 w-7 flex-shrink-0 items-center justify-center rounded bg-gray-100 text-[10px] font-bold uppercase text-gray-400">
                {card.file_type}
              </span>
            ...
            <div className="flex items-center gap-1">
              ...
              >
                <svg className={`h-4 w-4 ${card.is_favorite ? "text-yellow-500" : "text-gray-300"}`}
