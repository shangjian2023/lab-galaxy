    ...
    <AnimatePresence>
      ...
      >
        ...
        >
            ...
            {duplicates.map((dup, i) => (
              ...
              >
                ...
                <div className="mt-0.5 flex items-center gap-2 text-xs">
                  <span className="rounded bg-gray-200 px-1.5 py-0.5 text-black">已有</span>
                  <span className="text-gray-700">{dup.existing_name}</span>
                </div>
              </div>
            ))}
          </div>
          ...
          {loading && (
            <div className="mt-3 flex items-center justify-center gap-2 text-xs text-black">
